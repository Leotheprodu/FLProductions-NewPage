  ...
  return (
    <>
      ...
      <div className="w-full overflow-hidden">
        <section className="text-center py-20 px-6">
          <div>
            ...
            <p className="text-gray-600 mb-6 md:w-1/2 w-full mx-auto">
              ...
              producción Musical de Costa Rica, con mas de 15 años de
              experiencia
            </p>
          </div>
          ...
          <ul className="text-left text-gray-600 max-w-2xl mx-auto mt-20">
            <li className="flex items-center gap-2 mb-2">
              <span className="text-secundario">•</span>Realizamos grabaciones
            ...
            <li className="flex items-center gap-2 mb-2">
              <span className="text-secundario">•</span> Trabajamos la mayoría
            ...
            <li className="flex items-center gap-2 mb-2">
              <span className="text-secundario">•</span> Somos expertos en el
              uso de Melodyne
            </li>
            <li className="flex items-center gap-2 mb-2">
            ...
            <li className="flex items-center gap-2 mb-2">
              <span className="text-secundario">•</span> Contamos con un equipo
              de fotógrafos y de producción audiovisual de alto nivel
            </li>
            <li className="flex items-center gap-2 mb-2">
        ...
        <div className="flex flex-col xl:flex-row h-full w-full bg-gray-100 p-6 xl:p-20">
          <section
            id="about"
            className="xl:w-2/3 w-full h-full xl:h-[35rem] text-white flex flex-col justify-center items-center xl:rounded-l-lg"
            style={{
            ...
            <div className="bg-black/60 p-6 rounded-lg">
              <div>
                ...
                <p className="max-w-2xl">
                  ...
                  mastering y producción musical de alta calidad. Comprometidos
                  a ayudar a los artistas a alcanzar su máximo potencial.
                  Trabajamos con una variedad de géneros musicales y estamos
                  siempre dispuestos a explorar nuevas ideas y sonidos. En
                  FLProductions, creemos que la música es una forma de arte
                  poderosa y estamos aquí para ayudarte a contar tu historia a
                  través de ella.
                </p>
              </div>
              <div>
                ...
                <p className="max-w-2xl">
                  ...
                  música y la producción. Con más de 15 años de experiencia en
                  la industria, he trabajado con una variedad de artistas y
                  géneros musicales. Mi enfoque es crear un sonido único y
                  auténtico para cada proyecto. Mi objetivo es que cada artista
                  se sienta cómodo y inspirado en el estudio, para que juntos
                  podamos crear algo extraordinario. Estoy comprometido a
                  ofrecer un servicio de alta calidad y a trabajar de cerca
                  contigo en cada paso del proceso.
                </p>
              </div>
            </div>
          </section>
          ...
          <section
            id="contact"
            className="flex flex-col items-center justify-baseline h-full w-full xl:h-[35rem] xl:w-1/3 bg-gray-200 xl:rounded-r-lg"
          >
